...
script to make the qsub script to call edits.

Example: python3 ~/projects/STAMP/pacbio_pipeline/v3/workflow_read_level/scripts/make_read_level_edit_script_ct.py --working_directory ~/scratch/RBFOX2_pipeline_example/snakemake_test/read_level_analysis_annotated/RBFOX_3_chr1/output_dir/ --gtf_path ~/scratch/RBFOX2_pipeline_example/refs/gencode.v19.annotation.gtf --split_pickle ~/scratch/RBFOX2_pipeline_example/snakemake_test/read_level_analysis_annotated/RBFOX_3_chr1/output_dir/split_bam_RBFOX_3_chr1 --ref ~/scratch/RBFOX2_pipeline_example/refs/hg19.fa --job RBFOX_3_chr1 --script_path ~/projects/STAMP/pacbio_pipeline/v3/workflow_read_level/scripts/read_level_quant_se_ct_annotated.py
